...
INPUT_FILE = 'data/roadtraffic_Trim.mp4'
OUTPUT_FILE = 'out/output.avi'
...
while True:
    ...
    for output in layerOutputs:
        ...
        for detection in output:
            ...
            if confidence > CONFIDENCE_THRESHOLD and LABELS[int(classID)] == 'car':
                ...
                jsonDict[LABELS[int(classID)]+' '+str(carCounter)] = [int(centerX), int(centerY), int(width), int(height)]
                carCounter += 1
